...
**Invoking the Rune.** As an action, you can invoke the mantle’s rune to cast the [Sleet Storm](http://dnd5e.wikidot.com/spell:sleet-storm) spell (save DC 14) with it. When you use the mantle to cast the spell, the area of the spell isn’t difficult terrain for you, and you can see through the storm, ignoring the normal penalties of a heavily obscured area.
...
***Curse.*** This weapon is cursed, and becoming attuned to it extends the curse to you. Until the curse is broken with a [Remove Curse](http://dnd5e.wikidot.com/spell:remove-curse) spell or similar magic, you are unwilling to part with the weapon. Whenever you attack a creature with this weapon and roll a 1 on the attack roll, you suffer the effect of a [Polymorph](http://dnd5e.wikidot.com/spell:polymorph) spell for 1 hour, rolling on the table to determine your new form.
...
***If Ruidium Is Destroyed.*** If the Apotheon is killed or redeemed, all of the ruidium in Exandria is destroyed instantly, and the *Ring of Red Fury* becomes a [Ring of Free Action](/wondrous-items:ring-of-free-action).
...
***If Ruidium Is Destroyed.*** If the Apotheon is killed or redeemed, all of the ruidium in Exandria is destroyed instantly, and *Ruidium Armor* becomes [+1 Armor](/wondrous-items:armor-1-2-3).
...
***If Ruidium Is Destroyed.*** If the Apotheon is killed or redeemed, all the ruidium in Exandria is destroyed instantly, and a Ruidium Shield becomes a [+2 Shield](/wondrous-items:shield-1-2-3).
...
***If Ruidium Is Destroyed.*** If the Apotheon is killed or redeemed, all the ruidium in Exandria is destroyed instantly, and a Ruidium Weapon becomes a [+2 Weapon](/wondrous-items:weapon-1-2-3).
...
While wearing this item, you have resistance to necrotic damage. Additionally, you can cast the [Spare the Dying](http://dnd5e.wikidot.com/spell:spare-the-dying) cantrip using either an action or a bonus action.
...
***Winter's Howl.*** As an action, you can cast [Sleet Storm](http://dnd5e.wikidot.com/spell:sleet-storm) (spell save DC 17). You regain this ability after you finish a short or long rest.
...
**Bane.** You can cast the *[Bane](http://dnd5e.wikidot.com/spell:bane)* spell from the shield (save DC 17). The spell does not require concentration and lasts for 1 minute. Once you cast the spell from the shield you can't do so again until you finish a short or long rest.
...
Additionally, while wearing the helm, you can cast [Spirit of Death](http://dnd5e.wikidot.com/spell:spirit-of-death) from it without requiring material components. Once you use the helm to cast the spell, the helm can’t cast this spell again until the next dawn.
...
**Meld into Stone.** You can cast the [Meld into Stone](http://dnd5e.wikidot.com/spell:meld-into-stone) spell from this war pick. Once this property is used, it can’t be used again until the next dawn.
...
This trident has 3 charges. You can expend 1 charge to cast [Control Water](http://dnd5e.wikidot.com/spell:control-water) (save DC 15) from the trident or 3 charges to cast [Tsunami](http://dnd5e.wikidot.com/spell:tsunami) (save DC 15) from it instead. The trident regains 1d3 expended charges daily at dawn.
...
While attuned to this device, you have a +1 bonus to Dexterity saving throws and you always know which way is north. Additionally, you can cast the [Longstrider](http://dnd5e.wikidot.com/spell:longstrider) spell on yourself at will.
...
***Get Away From It All.*** As an action, you can cast the [Teleport](http://dnd5e.wikidot.com/spell:teleport) spell. Once you use this feature of the *timepiece of travel*, it cannot be used again until the next dawn.
...
As a bonus action, you can cast the [See Invisibility](http://dnd5e.wikidot.com/spell:see-invisibility) spell from the helm. Once this property of the helm is used, it can't be used again until the next dawn.
...
Spellcasting. The weapon has 5 charges. You can use a bonus action and expend 1 or more of its charges to cast one of the following spells (save DC 16): [Command](http://dnd5e.wikidot.com/spell:command) (1 charge), [Zone of Truth](http://dnd5e.wikidot.com/spell:zone-of-truth) (2 charges), [Compulsion](http://dnd5e.wikidot.com/spell:compulsion) (4 charges), [Banishment](http://dnd5e.wikidot.com/spell:banishment) (4 charges), or [Dominate Person](http://dnd5e.wikidot.com/spell:dominate-person) (5 charges).
...
While attuned to this device, you have a +1 bonus to Wisdom saving throws, and you can use an action to cast the [Dancing Lights](http://dnd5e.wikidot.com/spell:dancing-lights), [Guidance](http://dnd5e.wikidot.com/spell:guidance), or [Message](http://dnd5e.wikidot.com/spell:message) cantrips.
...
***Alter Gravity.*** As an action, you can cast [Fly](http://dnd5e.wikidot.com/spell:fly) on yourself or you can cast [Levitate](http://dnd5e.wikidot.com/spell:levitate) (save DC 15). Once you use this feature of the *wheel of stars*, it cannot be used again until the next dawn.
