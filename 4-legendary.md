...
*Blackrazor* can cast the [Haste](http://dnd5e.wikidot.com/spell:haste) spell on you once per day. It decides when to cast the spell and maintains concentration on it so that you don't have to.
...
While holding the weapon, you can use an action to touch a creature with the blade and cast [Lesser Restoration](http://dnd5e.wikidot.com/spell:lesser-restoration) on that creature. Once used, this ability can't be used again until the next dawn.
...
• You can cast [Dominate Monster](http://dnd5e.wikidot.com/spell:dominate-monster) (save DC 17) on an earth elemental. Once you have done so, *Ironfang* can’t be used this way again until the next dawn.

***Shatter.*** *Ironfang* has 3 charges. You can use your action to expend 1 charge and cast the 2nd-level version of [Shatter](http://dnd5e.wikidot.com/spell:shatter) (DC 17). *Ironfang* regains 1d3 expended charges daily at dawn.

***The Rumbling.*** While inside an earth node, you can perform a ritual called the Rumbling, using *Ironfang* to create a *devastation orb of earth* (see the [Devastation Orb](http://dnd5e.wikidot.com/wondrous-items:devastation-orb) description for the time and cost of the ritual). Once you perform the ritual, *Ironfang* can’t be used to perform the ritual again until the next dawn.
...
* In its Dormant State, the jewel has the following properties:
  ...
  * The jewel has 3 charges and regains all its expended charges daily at dawn. While holding the jewel, you can expend 1 charge from it to cast the [Invisibility](/spell:invisibility) spell.
...
You can use the properties of the [Wyrmskull Throne](http://dnd5e.wikidot.com/wondrous-items:wyrmskull-throne), as well as the properties of the scepter itself. The scepter has 10 charges, and it regains 1d6 + 4 expended charges at dawn. Its properties are as follows:

* If you are underground or underwater, you can use an action to expend 1 charge to determine the distance to the surface.
* As an action, you can expend 2 charges to cast the [Sending](http://dnd5e.wikidot.com/spell:sending) spell from the scepter.
* As an action, you can expend 3 charges to cast the [Teleport](http://dnd5e.wikidot.com/spell:teleport) spell from the scepter. If the destination is within 60 feet of the [Wyrmskull Throne](http://dnd5e.wikidot.com/wondrous-items:wyrmskull-throne), there is no chance of a teleport error or mishap occurring.
...
**Spellcasting.** While holding the bow, you can use an action to expend 1 or more of its charges to cast one of the following spells from it (save DC 18): [Create Food and Water](http://dnd5e.wikidot.com/spell:create-food-and-water) (1 charge), [Warding Bond](http://dnd5e.wikidot.com/spell:warding-bond) (2 charges), [Guardian of Faith](http://dnd5e.wikidot.com/spell:guardian-of-faith) (3 charges).
...
|85-86|                                                                                                                                                                                        The *moonblade* functions as a *[defender](http://dnd5e.wikidot.com/wondrous-items:defender)*.                                                                                                                                                                                        |        |
...
|97-98|                                                                                                                                                                           The *moonblade* functions as a *[ring of spell storing](http://dnd5e.wikidot.com/wondrous-items:ring-of-spell-storing)*.                                                                                                                                                                           |        |
...
| 00  |                                                                                                                                                                                    The *moonblade* functions as a *[vorpal sword](http://dnd5e.wikidot.com/wondrous-items:vorpal-sword)*.                                                                                                                                                                                    |        |
...
After either of these effects ends, the affected creature is no longer cursed. The curse can also be removed from a creature with a [Remove Curse](http://dnd5e.wikidot.com/spell:remove-curse) spell or similar magic. All cases of the curse end if *Murgaxor's orb* is destroyed.

***Magical Signature.*** As a side effect of the orb's curse, the spell [Detect Magic](http://dnd5e.wikidot.com/spell:detect-magic) reveals an aura of enchantment surrounding creatures bearing the curse. This aura is distinctive, but in a way [Detect Magic](http://dnd5e.wikidot.com/spell:detect-magic) offers no further details about.
...
A creature reduced to 0 hit points by this weapon dies and can’t be raised from the dead except by a deity or by a creature using a tablet of reawakening to cast the [True Resurrection](http://dnd5e.wikidot.com/spell:true-resurrection) spell.
...
***Ring of Air Elemental Command.*** You can expend 2 of the ring's charges to cast [Dominate Monster](http://dnd5e.wikidot.com/spell:dominate-monster) on an air elemental. In addition, when you fall, you descend 60 feet per round and take no damage from falling. You can also speak and understand Auran.
...
* You can cast the following spells from the ring, expending the necessary number of charges: [Chain Lightning](http://dnd5e.wikidot.com/spell:chain-lightning) (3 charges), [Gust of Wind](http://dnd5e.wikidot.com/spell:gust-of-wind) (2 charges), or [Wind Wall](http://dnd5e.wikidot.com/spell:wind-wall) (1 charge).

***Ring of Earth Elemental Command.*** You can expend a 2 of the ring's charges to cast [Dominate Monster](http://dnd5e.wikidot.com/spell:dominate-monster) on an earth elemental. In addition, you can move in difficult terrain that is composed of rubble, rocks, or dirt as if it were normal terrain. You can also speak and understand Terran.
...
* You can cast the following spells from the ring, expending the necessary number of charges: [Stone Shape](http://dnd5e.wikidot.com/spell:stone-shape) (2 charges), [Stoneskin](http://dnd5e.wikidot.com/spell:stoneskin) (3 charges), or [Wall of Stone](http://dnd5e.wikidot.com/spell:wall-of-stone) (3 charges).

***Ring of Fire Elemental Command.*** You can expend 2 of the ring's charges to cast [Dominate Monster](http://dnd5e.wikidot.com/spell:dominate-monster) on a fire elemental. In addition, you have resistance to fire damage. You can also speak and understand Ignan.

If you help slay a fire elemental while attuned to the ring, you gain access to the following additional properties:

* You are immune to fire damage.

* You can cast the following spells from the ring, expending the necessary number of charges: [Burning Hands](http://dnd5e.wikidot.com/spell:burning-hands) (1 charge), [Fireball](http://dnd5e.wikidot.com/spell:fireball) (2 charges), and [Wall of Fire](http://dnd5e.wikidot.com/spell:wall-of-fire) (3 charges).

***Ring of Water Elemental Command.*** You can expend 2 of the ring's charges to cast [Dominate Monster](http://dnd5e.wikidot.com/spell:dominate-monster) on a water elemental. In addition, you can stand on and walk across liquid surfaces as if they were solid ground. You can also speak and understand Aquan.

If you help slay a water elemental while attuned to the ring, you gain access to the following additional properties:

* You can breathe underwater and have a swimming speed equal to your walking speed.

* You can cast the following spells from the ring, expending the necessary number of charges: [Create or Destroy Water](http://dnd5e.wikidot.com/spell:create-or-destroy-water) (1 charge), [Control Water](http://dnd5e.wikidot.com/spell:control-water) (3 charges), [Ice Storm](http://dnd5e.wikidot.com/spell:ice-storm) (2 charges), or [Wall of Ice](http://dnd5e.wikidot.com/spell:wall-of-ice) (3 charges).
...
***Blighted Ruin.*** You can cast the [Blight](http://dnd5e.wikidot.com/spell:blight) spell from the weapon (DC 15). Once used, this property of the weapon can’t be used until the next dawn.

***Destructive Ruin.*** You can cast the [Disintegrate](http://dnd5e.wikidot.com/spell:disintegrate) spell from the weapon, but can target only a nonmagical object or a creation of magical force. Once used, this property of the weapon can’t be used until dawn seven days later.
...
|         All         |   [Banishment](/spell:banishment) (3 charges; the target is banished to the stone's extradimensional space for the spell's duration), [Mirror Image](/spell:mirror-image) (1 charge)   |
|   Black Sapphire    |                                               [Blight](/spell:blight) (3 charges), [Finger of Death](/spell:finger-of-death) (6 charges)                                               |
|       Diamond       |[Ice Storm](/spell:ice-storm) (3 charges), [Simulacrum](/spell:simulacrum) (6 charges; the duplicate created by the spell has the same number of hit points as the creature it imitates)|
|       Jacinth       |                                                  [Fireball](/spell:fireball) (2 charges), [Fire Storm](/spell:fire-storm) (6 charges)                                                  |
|    Rainbow Pearl    |                                      [Prismatic Spray](/spell:prismatic-spray) (6 charges), [Water Breathing](/spell:water-breathing) (2 charges)                                      |
|        Ruby         |                                                         [Fly](/spell:fly) (2 charges), [Teleport](/spell:teleport) (6 charges)                                                         |
...
This viscous, milky-white substance can form a permanent adhesive bond between any two objects. It must be stored in a jar or flask that has been coated inside with [Oil of Slipperiness](http://dnd5e.wikidot.com/wondrous-items:oil-of-slipperiness). When found, a container contains 1d6 + 1 ounces.

One ounce of the glue can cover a 1-foot square surface. The glue takes 1 minute to set. Once it has done so, the bond it creates can be broken only by the application of [Universal Solvent](http://dnd5e.wikidot.com/wondrous-items:universal-solvent) or [Oil of Etherealness](http://dnd5e.wikidot.com/wondrous-items:oil-of-etherealness), or with a [Wish](http://dnd5e.wikidot.com/spell:wish) spell.
...
If the sphere comes into contact with a planar portal, such as that created by the [Gate](http://dnd5e.wikidot.com/spell:gate) spell, or an extradimensional space, such as that within a [Portable Hole](http://dnd5e.wikidot.com/wondrous-items:portable-hole), the DM determines randomly what happens, using the following table.
...
**Invoking the Rune.** As an action, you can invoke the breastplate’s rune to cast the [Wall of Stone](http://dnd5e.wikidot.com/spell:wall-of-stone) spell (save DC 14) with it. When you cast the spell in this way, you have advantage on saving throws made to maintain concentration on the spell.
...
Witches of Rashemen created this Tiny stone tablet to counter the necromancy of the Red Wizards. As an action, you can cast [True Resurrection](http://dnd5e.wikidot.com/spell:true-resurrection) from the tablet. Once used in this way, the tablet turns to dust and is destroyed.
...
When you make an Intelligence (Arcana) check to control a [Sphere of Annihilation](http://dnd5e.wikidot.com/wondrous-items:sphere-of-annihilation) while you are holding this talisman, you double your proficiency bonus on the check. In addition, when you start your turn with control over a [Sphere of Annihilation](http://dnd5e.wikidot.com/wondrous-items:sphere-of-annihilation), you can use an action to levitate it 10 feet plus a number of additional feet equal to 10 x your Intelligence modifier.
...
* You can cast [Dominate Monster](http://dnd5e.wikidot.com/spell:dominate-monster) (save DC 17) on a fire elemental. Once you have done so, *Tinderstrike* can’t be used this way again until the next dawn.

***Dance of the All-Consuming Fire.*** While inside a fire node, you can perform a ritual called the Dance of the All-Consuming Fire, using *Tinderstrike* to create a *devastation orb of fire* (see the [Devastation Orb](http://dnd5e.wikidot.com/wondrous-items:devastation-orb) description for the time and cost of the ritual). Once you perform the ritual, *Tinderstrike* can’t be used to perform the ritual again until the next dawn.
...
This tube holds milky liquid with a strong alcohol smell. You can use an action to pour the contents of the tube onto a surface within reach. The liquid instantly dissolves up to 1 square foot of adhesive it touches including [Sovereign Glue](http://dnd5e.wikidot.com/wondrous-items:sovereign-glue).
...
* As an action, you can use the verminshroud to cast [Polymorph](http://dnd5e.wikidot.com/spell:polymorph) on yourself, transforming into a **giant rat** or **rat** while retaining your Intelligence, Wisdom, and Charisma scores, as well as the properties of the cloak. This property can't be used again until the next dawn.

***Awakened.*** While wearing the *Verminshroud* in its awakened state, you gain the following benefits:

* You have resistance to poison damage.
* You can use an action to cast the [Insect Plague](http://dnd5e.wikidot.com/spell:insect-plague) spell (save DC 15) from the *Verminshroud*, requiring no material components. This property can't be used again until the next dawn.
* When you cast the [Polymorph](http://dnd5e.wikidot.com/spell:polymorph) spell using the *Verminshroud*, you can transform into a **giant wasp**.
...
* When you cast the [Polymorph](http://dnd5e.wikidot.com/spell:polymorph) spell using the *Verminshroud*, you can transform into a **giant scorpion**.
...
The weapon also functions as a [Trident of Fish Command](http://dnd5e.wikidot.com/wondrous-items:trident-of-fish-command) and a [Weapon of Warning](http://dnd5e.wikidot.com/wondrous-items:weapon-of-warning). It can confer the benefit of a [Cap of Water Breathing](http://dnd5e.wikidot.com/wondrous-items:cap-of-water-breathing) while you hold it, and you can use it as a [Cube of Force](http://dnd5e.wikidot.com/wondrous-items:cube-of-force) by choosing the effect, instead of pressing cube sides to select it.
...
The sword also functions as a [Wand of Enemy Detecetion](http://dnd5e.wikidot.com/wondrous-items:wand-of-enemy-detection). It regains all of its expended charges at dawn and isn't at risk of crumbling if its last charge is used.
...
* You have resistance to lightning damage.
* You can cast [Dominate Monster](http://dnd5e.wikidot.com/spell:dominate-monster) (save DC 17) on an air elemental. Once you have done so, *Windvane* can’t be used this way again until the next dawn.

***Song of the Four Winds.*** While inside an air node, you can perform a ritual called the Song of the Four Winds, using *Windvane* to create a *devastation orb of air* (see the [Devastation Orb](http://dnd5e.wikidot.com/wondrous-items:devastation-orb) description for the time and cost of the ritual). Once you perform the ritual, *Windvane* can’t be used to perform the ritual again until the next dawn.
...
* While carrying the vane, the creature attuned to it can cast the [Dancing Lights](http://dnd5e.wikidot.com/spell:dancing-lights), [Polymorph](http://dnd5e.wikidot.com/spell:polymorph), or [Ray of Frost](http://dnd5e.wikidot.com/spell:ray-of-frost) spell as an action, requiring no spell components and using Charisma as the spellcasting ability. After the vane's [Polymorph](http://dnd5e.wikidot.com/spell:polymorph) spell is cast, roll a d8; on a roll of 3 or 8, the vane can't be used to cast this spell again until the next dawn.
