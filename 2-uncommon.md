...
This concoction looks, smells, and tastes like a [Potion of Healing](http://dnd5e.wikidot.com/wondrous-items:potion-of-healing) or other beneficial potion. However, it is actually poison masked by illusion magic. An [Identify](http://dnd5e.wikidot.com/spell:identify) spell reveals its true nature.
...
*Sending stones* come in pairs, with each smooth stone carved to match the other so the pairing is easily recognized. While you touch one stone, you can use an action to cast the *[sending](/spell:sending)* spell from it. The target is the bearer of the other stone. If no creature bears the other stone, you know that fact as soon as you use the stone and don't cast the spell.
...
This polished agate appears to be a [Stone of Good Luck](http://dnd5e.wikidot.com/wondrous-items:luckstone) to anyone who tries to identify it, and it confers that item's property while on your person.
...
This wand has 7 charges. While holding it, you can use an action to expend 1 of its charges to cast the [Entangle](http://dnd5e.wikidot.com/spell:entangle) spell (save DC 13) from it.
...
This wand has 7 charges. While holding it, you can use an action to expend 1 of its charges to cast the [Web](http://dnd5e.wikidot.com/spell:web) spell (save DC 15) from it.
